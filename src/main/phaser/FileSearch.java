...
tasks. The three tasks look for files with the extension .java modified in the last 24 hours in
three different folders and their subfolders. This task is divided into three steps:
1. Get a list of the files with the extension .java in the assigned folder and
its subfolders.
